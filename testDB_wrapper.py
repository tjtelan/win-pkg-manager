...
print("Add File - Empty Table", db_wrapper.add_update_file(mydb, "latestApp", "1.5", "install.exe", "installers/", "exe")) 
print("Get File", db_wrapper.get_app_currFile(mydb, "latestApp")) 
